 ...
 * 3. If you re-calibrate the Field Weakening please take all the safety measures! The motors can spin very fast!
   ...
   Inputs:
    - input1.cmd and input2.cmd: normalized input values. INPUT_MIN to INPUT_MAX
    - button1 and button2: digital input values. 0 or 1
    - adc_buffer.breakPadel and adc_buffer.throttle: unfiltered ADC values (you do not need them). 0 to 4095
   Outputs:
...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  #define PRI_INPUT1              1,  975, 2093, 3211, 0  // Pedal Brake        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2              1,   926, 2050, 3174, 0  // Pedal Accel        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  ...
  #define MULTI_MODE_DRIVE                  // This option enables the selection of 3 driving modes at start-up using combinations of Brake and Throttle pedals (see below)
      ...
      // Rverse Mode:
      #define MULTI_MODE_DRIVE_MR_MAX   250
      #define MULTI_MODE_DRIVE_MR_RATE  250
      #define MULTI_MODE_MR_I_MOT_MAX   8
      #define MULTI_MODE_MR_N_MOT_MAX   80

      // BEGINNER MODE:     Power ON + Brake [released] + Throttle [released or pressed]
      #define MULTI_MODE_DRIVE_M1_MAX   350
